...
public class MyElGamal {
    ...
    public static void main(String[] args) throws Exception {
        //初始化密钥
        //生成密钥对
        Map<String,Object> keyMap= MyElGamal.initKey();
        //公钥
        byte[] publicKey= MyElGamal.getPublicKey(keyMap);

        //私钥
        byte[] privateKey= MyElGamal.getPrivateKey(keyMap);
        ...
        //乙方使用公钥对数据进行加密
        byte[] code2= MyElGamal.encryptByPublicKey(str.getBytes(), publicKey);
        System.out.println("===========乙方使用公钥对数据进行加密==============");
        System.out.println("加密后的数据："+Base64.encodeBase64String(code2));


        //甲方使用私钥对数据进行解密
        byte[] decode2= MyElGamal.decryptByPrivateKey(code2, privateKey);
